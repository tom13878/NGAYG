...
# Introduction
Yield gap is a powerful concept to illustrate by how much crop yield can be increased.  and has therefore been used by both policy makers.  Despite its abundant use, various definitions are used to measure the yield gap which are not always comparable [@Sumberg2012]. 
...
_Actual yield._ Actual yield (Ya), also sometimes referred to as (average) farm yield [@Fischer, @VanIttersum2013], is the observed yield at the field, farm  or regional level expressed in kilograms or metric tonenes per hectare (kg/ha or t/ha). 
...
_Attainable yield_ The notion of 'attainable' yield is used very frequently in the yield gap literature but in an inconsistent way, meaning a number of things. @Fischer2015 equates attainable yield with our definition of *economic yield* by defining it as *'the yield attained by a farmer from average natural resources when economically optimal practices and levels of inputs have been adopted while facing the vagaries of weather'* [p.32]. @Sadras2015 use the following definition: *'the best yield achieved through skilful use of the best available technology'* [p. 6]. A similar definition is provided by [@Tittonell2013], who coin the term 'locally attainable yield'. In this case the concept of attainable yield to efficiency and use of best-available technology instead of economic constraints. We argue that this is the same to our definition of *feasible yield*. Finally, several researchers take an empirical approach and estimate attainable yield as the average yield of plots or farms with the highest yield in the sample of observations [@Tittonell2013r, @Laborte]. The criteria to select farmers is in most cases the top decile or 95% percentile of the cumulative relative frequency curve of yield estimates [@Hall2013]. In many cases, the empirically observed attainable yield is used as an approximation of (water-limited) potential yield. We argue that this definition of attainable yield is identical to the *best-farmers yield*. 
