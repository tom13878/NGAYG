...
# Introduction
Yield gap is a powerful concept to illustrate the potential to increase future crop yield. It is defined as the difference between potential yield and actual yield observed at the plot, farm or regional level. Despite its abundant use, numerous definitions are used to quantify the yield gap which makes comparison difficult and adds to the confusion. In a recent review of the use of yield gap analysis in key policy papers @Sumberg concluded that _"it is most often used without the discipline or caveats associated with the best examples of its use in crop production ecology and microeconomics"_ [p.509] and _"there is a tension between the notion of yield gap as developed in crop ecology (although even here there is no single or consistent usage) and micro-economic studies"_ [p. 510]. 
This
...
In a recent paper, @Fischer2015 reviewed the most common definitions of yield levels and yield gaps. This studydwork extends the work of @Fisher2015 by (1) 


and builds on Van Dijk et al. [@VanDijk] and Silva et al. [@Silva] by contrasting and extending agricultural/agronomical(?) definitions of crop yield and yield gap with comparable but conceptually different measures used in the economic literature. 
